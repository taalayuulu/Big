                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        <li class="scroll active">
                            <a href="../index.php"><?php echo $LANG['menu1'] ;?></a>
                        </li>
        ...
        <div class="container">
            <div class="row">
                ...
                <img class="img-responsive img-rounded" src="../images/blog/05.jpg" alt="">
                  ...
                  <h1><a><?php echo $LANG['ntema3'] ?></a></h1>
                   <br>
                   <hr>
                    <?php echo  $LANG['ncontent3']; ?>
                   
                    <p>
                        <a href="ttp://www.worldbank.org/ru/results/2016/04/13/partnering-for-economic-growth-and-job-creation-in-the-kyrgyz-republic"><?php echo $LANG['istochnik']?>: www.worldbank.org/ru </a>.
                    </p>
