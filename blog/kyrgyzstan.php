        ...
        <div class="container">
            <div class="row">
                ...
                <img class="img-responsive img-rounded" src="../images/blog/04.jpg" alt="">
                  ...
                  <h1><a><?php echo $LANG['ntema4'] ?></a></h1>
                   <br>
                   <hr>
                    <?php echo  $LANG['ncontent4']; ?>
                   
                    <p>
                        <a href="http://www.kabar.kg/kabar/full/44876" target="blank"><?php echo $LANG['istochnik']?>: www.kabar.kg/kabar/full/44876</a>.
                    </p>
